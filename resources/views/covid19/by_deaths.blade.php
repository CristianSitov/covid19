...
@section('content')
<div class="container">
    <h6>COVID 19 <small>(data: <span class="date">____-__-__</span>)</small> | <a href="/covid19/">by cases</a> | <a href="/covid19/world">world</a></h6>
...
<script>
    ...
    function getChartData() {
        $.ajax({
            url: window.location.origin + "/covid19/covid.json?type=deaths&days=60&start_from=0&end_at=10000&cut_off=10",
